...
g++ $0 shaderprogram.cpp -std=c++11 -g -o test4 -lSDL2 -lGL  -fmax-errors=5 -I../obj-advanced-loader/include/
...
int main(int argc, char *argv[]) {
    ...
    //    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, 2); //This prevents
    //    the rendering function from rendering anything of some reason
    ...
    mainwindow = SDL_CreateWindow("sdl-window",
